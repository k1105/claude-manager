# Claude Manager - ADHD特性を持つクリエイターのためのAIマネージャー

Claude Code上で動作する、ADHD特性を持つクリエイター・ビジネスパーソンのための専属AIマネージャーシステムです。
...
ADHD特性を理解した上で設計されています：

- **「今これをやろう、なぜならXだから」** -- 根拠のある許可出しをする
- **一度に1つ** -- 最優先の1つを明確にする
- **責めない** -- 事実を伝えて、次の一手を示す
- **記録は全自動** -- 人力ゼロを前提にする
